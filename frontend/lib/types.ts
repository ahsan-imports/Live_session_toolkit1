...
export interface SessionSummary { id: string; title: string; code: string; status: SessionStatus; created_at: string; launched_at: string | null; ended_at: string | null; }
...
export interface QuestionResult { question_id: string; prompt: string; question_type: QuestionType; total_responses: number; options: OptionResult[]; text_responses: string[]; }
